...
::: {.notes}
* Organisatorisch: Hier __finden Sie__ alles zum heutigen Workshop<br />-> [__Chat kopieren__] + [__öffnen__]
* Mich interessiert Ihr Vorwissen & was in der Vorbereitung geklappt hat<br />-> ein paar Fragen [__Chat kopieren__]<br />-> dient auch als __Codebook-Beispiel__
:::
...
::: {.notes}
* Codebook-package nicht von mir
* Enthusiastischer User der Produkte von Ruben Arslan
* Kann evtl. nicht alle Fragen beantworten<br />-> schreibe sie aber gerne auf und frage ihn
:::
...
::: {.notes}
* Was meine ich, wenn ich von Reproduzierbarkeit spreche?<br />-> immer wieder auf unterschiedliche Verwendungen gestoßen
* Macht auch Sinn: ...
:::
...
::: {.notes}
* "scientific claims" können dann besonders gut evaluiert werden, wenn die Evidenz auf der sie beruhen überprüft werden können
* Tendenz von Authoren das zu berichten, was sie als wichtig empfinden
...
::: {.notes}
* 163 (70%) of the 232
* in a __strict__ sense (59%), e.g. __df__
* 52% if procedure in the paper was followed
:::
...
::: {.notes}
* Wissenschaftler*innen werden selten so deutlich
* kann mir vorstellen, wie angry sie waren
:::
...
::: {.notes}
* Der __Fokus__ in der Wissenschaft aktuell immer noch auf Paper-Publications.
* Auch wenn Daten geteilt werden, sind sie oftmals nicht "FAIR"
:::
...
::: {.notes}
* Metadaten auf der Ebene des gesamten Datensatzes<br />-> _Findable_
* Metadaten auf der Ebene der einzelnen Variablen / Ausprägungen der Var<br />-> Reusable
:::
...
::: {.notes}
* __Übersicht__: verbessert Reproduzierbarkeit und Nachnutzung
* __Nachvollziehbarkeit__: Inhalt und Struktur des Datensatzes transparenter machen -> leichter zu beurteilen, ob ich Daten wiederverwenden möchte
* __Standardisierung__: einfachere Nachvollziehbarkeit; Suchmaschinen brauchen Standards
:::
...
::: {.notes}
* Codebook produzieren <br />+ Ergebnisse mit Teilnehmenden durchsprechen
* Installationsprobleme: Gleich ein Raum mit mir
:::
